...
/**
 * This exception should be thrown when there's an error validating a location object
 * generated by a location engine.
 */
class LocationValidationException(errors: List<String>) : Exception("Failed to validate a location object, errors: $errors")
