    ...
    override fun startTrip() {
        runBlocking(mainDispatcher) {
            ...
            mapboxNavigation.apply {
                this.historyRecorder.startRecording()
                startTripSession()
            }
            mapboxReplayer?.play()
        }
            ...
            mapboxNavigation.apply {
                ...
                historyRecorder.stopRecording { historyDataFilepath ->
                    if (historyDataFilepath != null) {
                        ...
                        val historyEvents = MapboxHistoryReader(historyDataFilepath).asSequence()
                            .mapNotNull { historyMapper.mapToReplayEvent(it) }.toList()
            ...
            mapboxNavigation.requestRoutes(
                ...
                object : RouterCallback {
                    override fun onRoutesReady(routes: List<DirectionsRoute>, routerOrigin: RouterOrigin) {
                        ...
                        // tODO - need to set the routes probably?
                    ...
                    override fun onFailure(reasons: List<RouterFailure>, routeOptions: RouteOptions) {
                        val throwable = reasons.first().throwable!! // TODO - dangerous, this may be NPE
