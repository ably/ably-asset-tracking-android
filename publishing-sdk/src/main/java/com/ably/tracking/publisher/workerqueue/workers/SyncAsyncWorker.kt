 ...
 * */
internal interface SyncAsyncWorker : Worker<PublisherProperties, SyncAsyncResult> {
    /**
     ...
     * function.
     *
     * @param input : Current state of publisher to be used by this worker.
     *
     * Please use [input] directly only at synchronous part of code. If you need to pass this
     ...
     * **/
    override fun doWork(input: PublisherProperties): SyncAsyncResult
}
